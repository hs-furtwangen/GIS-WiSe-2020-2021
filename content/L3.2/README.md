...
let myURL: url.URL = new url.URL(adresse, "https://example.com"); //Der hintere Teil wird von uns nicht gebraucht, aber die URL muss eine Base-URL enthalten, damit wir keinen Fehler im späteren Verlauf des Programmes erhalten.
...
/*Die searchParams Eigenschaft gibt ein Ojekt zurück, dass alle query-string Parameter als Eigenschaften besitzt. So können beliebig gesendete Attribute ausgelesen werden:*/
