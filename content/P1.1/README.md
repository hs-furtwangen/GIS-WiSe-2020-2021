...
(1.) Richten Sie sich eine vollständige Arbeitsumgebung ein, in dem Sie z.B. folgende Schritten durchführen:
...
(2.) Erstellen Sie eine stillose Webstite (reines HTML-Dokument **KEIN CSS oder JS**) zu Ihrer Person die mindestens folgende Elemente enthält:
...
(3.) Entdecken Sie die Entwicklungswerkzeuge, die in Ihrem Browser eingebaut sind:
...
Sie sind arbeitsfähig, d.h. Sie haben sich auf der Kursseite registriert und kennen sich mit den grundlegensten Funktionen von GIT aus. Sie sind dazu in der Lage Ihre Abgaben auf GitHub hochzuladen.

Sie haben Ihre erste einfache Website erstellt in der Sie sich selbst vorstellen.
